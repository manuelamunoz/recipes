...
__all__ = ["MSOffice2019VersionChecker"]


class MSOffice2019VersionChecker(Processor):
    """Checks a downloaded Office 2019 app package to verify that the version
...
if __name__ == "__main__":
    processor = MSOffice2019VersionChecker()
